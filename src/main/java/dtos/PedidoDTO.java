...
public class PedidoDTO implements Serializable {
    ...
    private static final long serialVersionUID = -5491186972145618619L;
    ...
    public PedidoDTO(Integer id, Date fechaSolicitudOrden, Date fechaDespacho, Date fechaEntrega, String estado, String direccionEntrega) {
        this.id = id;
